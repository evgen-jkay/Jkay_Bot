...
import bots.updateshandlers.CommandsHandler;
import bots.updateshandlers.WebHookExampleHandlers;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                telegramBotsApi.registerBot(new CommandsHandler(BotConfig.BOT_NAME));
